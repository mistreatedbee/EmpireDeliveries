...
export default function RestaurantStep3() {
  ...
  const handleNext = () => {
    if (!validate()) return;
    router.push({
      pathname: '/(auth)/restaurant-signup/step-4',
      params: {
        ...params,
        bankName,
  ...
  return (
    <View style={{ flex: 1, backgroundColor: T.bg }}>
      ...
      >
        ...
        <Button onPress={handleNext} size="lg" style={{ marginTop: 8 }}>
          Next
        </Button>
      </ScrollView>
    </View>
